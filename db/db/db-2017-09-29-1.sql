...
prompt Created on 2017年9月29日 by Kor_Zhang
set feedback off
set define off
...
values ('8', '网站统计', null, null, null, null, null, null, 0);
insert into PERMISSIONS (ID, TEXT, TYPE, URL, CODE, PID, PIDS, SORT, STATUS)
...
insert into PERMISSIONS (ID, TEXT, TYPE, URL, CODE, PID, PIDS, SORT, STATUS)
values ('1', '用户管理', 'p', '/manage/view/users_manage.jsp', 'users:select', '5', null, null, 1);
insert into PERMISSIONS (ID, TEXT, TYPE, URL, CODE, PID, PIDS, SORT, STATUS)
values ('4', '管理员管理', 'p', '/manage/view/admins_manage.jsp', null, '6', null, null, 1);
insert into PERMISSIONS (ID, TEXT, TYPE, URL, CODE, PID, PIDS, SORT, STATUS)
values ('7', '用户统计', 'p', '/manage/view/users_chart.jsp', null, '8', null, null, 1);
insert into PERMISSIONS (ID, TEXT, TYPE, URL, CODE, PID, PIDS, SORT, STATUS)
values ('10', '商品管理', 'p', '/manage/view/goods_manage.jsp', null, '9', null, null, 1);
insert into PERMISSIONS (ID, TEXT, TYPE, URL, CODE, PID, PIDS, SORT, STATUS)
values ('11', '商品类型管理', 'p', '/manage//view/clazzs_manage.jsp', null, '9', null, null, 0);
commit;
...
insert into ROLES_PERMISSIONS (ID, ROLE, PERMISSION, GRANTTIME)
values ('2', '2', '1', to_timestamp('15-09-2017 10:18:09.000000', 'dd-mm-yyyy hh24:mi:ss.ff'));
commit;
prompt 2 records loaded
