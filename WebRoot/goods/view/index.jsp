			...
			<ul>
				<li>
					<div class="trading_info_title">
						<img src="goods/img/content_icon.png" title="xxxxxxxx" /> <a
							href="#">xxxxxx</a>
					</div> <a href="#"><img src="goods/img/content.png" /></a>

					<div class="trading_price">
						<span>￥<span>5.0</span></span> <span>江苏&nbsp;南通</span>
					</div>
					<hr />
					<p>短裤短裤短裤短裤</p> <span class="time">9分钟前</span> <span class="come">来自
